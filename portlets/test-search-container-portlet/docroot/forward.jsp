...
<c:if test="<%= Validator.isNotNull(formNumber) %>">

	<%
	PortletURL portletURL = renderResponse.createRenderURL();

	portletURL.setParameter("formNumber", formNumber);
	portletURL.setParameter("mvcPath", mvcPath);
	%>

	<liferay-portlet:actionURL name="testLastPagination" var="testURL">
		<portlet:param name="formNumber" value="<%= formNumber %>" />
...
<c:if test="<%= Validator.isNotNull(nextFormNumber) %>">
	<liferay-portlet:actionURL name="initSearchContainer" var="initURL">
