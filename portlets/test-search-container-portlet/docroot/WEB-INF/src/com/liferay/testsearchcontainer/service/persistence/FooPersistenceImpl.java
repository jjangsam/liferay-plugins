...
import com.liferay.testsearchcontainer.model.impl.FooImpl;
import com.liferay.testsearchcontainer.model.impl.FooModelImpl;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_FETCH_BY_VALUE = new FinderPath(FooModelImpl.ENTITY_CACHE_ENABLED,
			FooModelImpl.FINDER_CACHE_ENABLED, FooImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByValue",
			new String[] { Integer.class.getName() },
			FooModelImpl.VALUE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_VALUE = new FinderPath(FooModelImpl.ENTITY_CACHE_ENABLED,
	...
	public void cacheResult(Foo foo) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_VALUE,
			new Object[] { Integer.valueOf(foo.getValue()) }, foo);
	...
	protected void clearUniqueFindersCache(Foo foo) {
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_VALUE,
			new Object[] { Integer.valueOf(foo.getValue()) });
	}
	...
	@Override
	public Foo updateImpl(com.liferay.testsearchcontainer.model.Foo foo,
		...
		if (isNew) {
			...
			if ((fooModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Integer.valueOf(fooModelImpl.getOriginalValue())
					};
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Foo findByValue(int value)
		throws NoSuchFooException, SystemException {
		Foo foo = fetchByValue(value);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Foo fetchByValue(int value) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Foo fetchByValue(int value, boolean retrieveFromCache)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Foo removeByValue(int value)
		throws NoSuchFooException, SystemException {
		Foo foo = findByValue(value);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByValue(int value) throws SystemException {
		Object[] finderArgs = new Object[] { value };
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.testsearchcontainer.model.Foo")));
	...
	private static final String _FINDER_COLUMN_VALUE_VALUE_2 = "foo.value = ?";
